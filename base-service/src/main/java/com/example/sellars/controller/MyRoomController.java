...
public class MyRoomController {
    ...
    private final YandexPhoto google;
    ...
    public String infoProduct(@PathVariable("id") Long id,
                              Principal principal, Model model) throws IOException, InterruptedException {
    ...
    public String createProduct(@RequestParam("files") List<MultipartFile> files,
                                Product product, Principal principal) throws GeneralSecurityException, IOException, InterruptedException, URISyntaxException {
    ...
    public String pageUpdateProduct(@PathVariable("id") Long id, Principal principal, Model model) throws IOException, InterruptedException {
